 ...
 * Class used from the ResultSetTableModel class given in the code examples
 */
...
public class ResultSetTableModel extends AbstractTableModel 
{
   ...
   public ResultSetTableModel( String driver, Connection connection, String query) 
